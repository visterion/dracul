export default {
  ...
  proposals: {
    ...
    news: 'News',
    actions: {
      buy: 'Buy', add: 'Add', trim: 'Trim', sell: 'Sell',
      hold: 'Hold', drop_from_watchlist: 'Drop from watchlist',
    },
    sentiment: { positive: 'positive', negative: 'negative', neutral: 'neutral' },
  },
  depots: {
    title: 'Depots',
    subtitle: 'All connected broker depots at a glance.',
    refresh: 'Refresh',
    loading: 'Loading depots …',
    empty: 'No depots connected yet.',
    loadError: 'Could not load the depots.',
    ...
    orders: {
      title: 'Orders',
      col: { symbol: 'Symbol', side: 'Side', qty: 'Qty', type: 'Type', price: 'Price', status: 'Status', role: 'Role' },
    ...
    transcript: {
      ...
      imageRedactedInline: 'Image redacted',
      toolUseInline: 'calls {name}',
    },
  },
  calibration: {
