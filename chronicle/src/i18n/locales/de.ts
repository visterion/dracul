export default {
  ...
  proposals: {
    title: 'Renfield — Watchlist-Review',
    eyebrow: 'Renfield',
    ...
    news: 'Nachrichten',
    actions: {
      buy: 'Kaufen', add: 'Nachkaufen', trim: 'Trimmen', sell: 'Verkaufen',
      hold: 'Halten', drop_from_watchlist: 'Von Watchlist entfernen',
    },
    sentiment: { positive: 'positiv', negative: 'negativ', neutral: 'neutral' },
  },
  depots: {
    title: 'Depots',
    subtitle: 'Alle verbundenen Broker-Depots im Überblick.',
    refresh: 'Aktualisieren',
    loading: 'Lade Depots …',
    empty: 'Noch keine Depots verbunden.',
    loadError: 'Depots konnten nicht geladen werden.',
    selector: { label: 'Depot' },
    summary: { cash: 'Cash' },
    ...
    chart: {
      ...
      reconstructed: 'Bis {date} rekonstruiert aus Buch und Tageskursen — Gebühren und Dividenden fehlen, die Abweichung wächst nach hinten.',
    },
    metric: { label: 'Kennzahl', sinceBuy: 'Seit Kauf', today: 'Heute' },
    positions: { empty: 'Keine Positionen in diesem Depot.' },
    orders: {
      title: 'Orders',
      col: { symbol: 'Symbol', side: 'Richtung', qty: 'Stück', type: 'Typ', price: 'Preis', status: 'Status', role: 'Rolle' },
    ...
    detail: {
      back: 'Zurück zu Depots',
      notFound: 'Position nicht gefunden.',
      brokerDown: 'Broker nicht erreichbar.',
    ...
    transcript: {
      ...
      more: 'mehr',
      less: 'weniger',
      stopReason: 'Stop-Grund',
      imageRedactedInline: 'Bild redigiert',
      toolUseInline: 'ruft {name} auf',
    },
  },
  calibration: {
    sectionLabel: 'Kalibrierung',
    title: 'Executor-Kalibrierung',
    loadError: 'Kalibrierungs-Analysen konnten nicht geladen werden.',
    insufficient: 'unzureichende Daten (n={n} < 30)',
    executor: 'Executor',
    brierTitle: 'Brier-Score',
    vetoPrecision: 'Veto-Präzision',
    behaviorTitle: 'Verhalten',
    emptyHunters: 'Noch keine Hunter-Ergebnisse.',
    emptyVeto: 'Noch keine kontrafaktischen Veto-Ergebnisse.',
    cols: {
      hunter: 'Hunter',
      n: 'n',
      brier: 'Brier',
      range: 'Bereich',
      predicted: 'Ø vorhergesagt',
      observed: 'Beobachtete Trefferquote',
      reason: 'Grund',
      skipped: 'Übersprungen',
      r20d: 'Ø R 20T',
      r60d: 'Ø R 60T',
      stoppedOut: 'Ausgestoppt',
    },
    tiles: {
      latencyMax: 'Hard-Exit-Latenz (max)',
      latencyP95: 'Hard-Exit-Latenz (p95)',
      whipsawReentry: 'Wiedereinstieg binnen 10T',
      whipsawRoundtrip: 'Roundtrip unter 5T',
      slippageMean: 'Slippage (Ø)',
      slippageWorst: 'Slippage (schlechteste)',
    },
  },
  exitSignal: {
    back: 'Depots',
