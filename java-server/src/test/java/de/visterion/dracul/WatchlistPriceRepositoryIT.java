...
class WatchlistPriceRepositoryIT {
    ...
    void distinctTickersAndUpdatePrice() {
        ...
        repo.insert("user1", "TSTX", "Test X", 100.0, java.util.List.of(), null, null);
        repo.insert("user2", "TSTX", "Test X dup", 100.0, java.util.List.of(), null, null);
        repo.insert("default", "TSTY", "Test Y", 50.0, java.util.List.of(), null, null);
