...
class StrigoiEchoWebhookControllerIT {
    ...
    void setUp() {
        ...
        var enriched = new EnrichedPeadCandidate(
                ...
                java.time.LocalDate.now().plusDays(40), 40, 12, true, List.of(), 0);
    ...
    void toolEndpointReturns200WithEnrichedCandidate() {
        ...
        assertThat(c0.path("analystCoverage").asInt()).isEqualTo(12);
        assertThat(c0.path("coverageAvailable").asBoolean()).isTrue();
