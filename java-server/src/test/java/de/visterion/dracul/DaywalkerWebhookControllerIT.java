...
class DaywalkerWebhookControllerIT {
    ...
    void eventsEndpointReturnsDetectedEvents() {
        watchlist.insert("default", "SPK", "Spike Co", 100.0, List.of(100.0), "TRACKING", "manual", null, null);
    ...
    void completeEndpointPersistsAlert() {
        watchlist.insert("default", "CMP", "Complete Co", 80.0, List.of(80.0), "TRACKING", "manual", null, null);
    ...
    void completePersistsTaxonomyEventType() {
        watchlist.insert("default", "EV1", "Event Co 1", 10.0, List.of(10.0), "TRACKING", "manual", null, null);
    ...
    void completeWithoutEventTypePersistsNull() {
        watchlist.insert("default", "EV2", "Event Co 2", 10.0, List.of(10.0), "TRACKING", "manual", null, null);
    ...
    void completeWithUnknownEventTypePersistsNull() {
        watchlist.insert("default", "EV3", "Event Co 3", 10.0, List.of(10.0), "TRACKING", "manual", null, null);
    ...
    void completeWithNoneEventTypePersistsNull() {
        watchlist.insert("default", "EV4", "Event Co 4", 10.0, List.of(10.0), "TRACKING", "manual", null, null);
    ...
    void completeWithOtherEventTypePersistsOtherLiterally() {
        watchlist.insert("default", "EV5", "Event Co 5", 10.0, List.of(10.0), "TRACKING", "manual", null, null);
    ...
    void criticalCompletionPushesAndMarksNotificationSent() {
        watchlist.insert("default", "CRT", "Critical Co", 70.0, List.of(70.0), "TRACKING", "manual", null, null);
    ...
    void infoCompletionDoesNotPush() {
        watchlist.insert("default", "INF", "Info Co", 40.0, List.of(40.0), "TRACKING", "manual", null, null);
